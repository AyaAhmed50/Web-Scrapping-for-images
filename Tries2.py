#https://www.youtube.com/watch?v=LXRx6FgiiEc
...
# Configure WebDriver
driver_path = "chromedriver-win64/chromedriver.exe"  # Replace with the actual path to the downloaded driver
car_list = [
    # "toyota+RAV4",
    # "toyota+86",
    # "toyota+Sienna",
...
views = {
    ...
    "back+angle+view": 10,
    "on+the+road": 10,
    "tailight+view+photoshoot": 10,
    "headlight+view+photoshoot": 10,
    "modifications+photoshoot": 10
}
...
for car_model in car_list:
    for angle, numOfPics in views.items():
        ...
        options.add_argument('--user-data-dir=C:/Users/Adminstrator/AppData/Local/Google/Chrome/User Data/Default')
        ...
        folder_path = 'D:/Achademy projects/Graduation Project/SuperStore/WebScrapping/imgs/'  # change your destination path here
